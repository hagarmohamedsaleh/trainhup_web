...
if(isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM company_signup WHERE email = ?";
    ...
    if($result->num_rows > 0){
        while($row = $result->fetch_assoc()){
            if(isset($row['username'])){  
                ...
                $link = "<a href='company_Reset_pass.php?MnoQtyPXZORTE=$id_encode' class='btn btn-info btn-sm'>Receive Mail</a>";
            } else {
...
<body  class="bg-secondary">
    <br><br><br><br>
        ...
        <div style="color:black;text-align:center;margin-top:11rem" class="credit">&copy; copyright @ 2023 by <span>TechnoLava Team: Faculty Of Computer Science And Artificial Intelligence</span> | all rights reserved!</div>
